...
export const buyWoodenNickelTheDeal = async (nft: NftInMarketplace, userWallet: any, amount: number) => {
    ...
    const response = await buyNftInMarket(userWallet, nft, conn, WoodenNickelIDL, WOODEN_NICKEL_PROGRAM_ID, amount, REWARD_TOKEN)
