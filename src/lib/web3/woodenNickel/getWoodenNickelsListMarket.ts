...
import { getNftListToSell } from "../common/getNftListToSell"
...
export const getWoodenNickelsListMarket = async (userWallet: any,) => {
    ...
    const nftsInMarketplace = await getNftListToSell(userWallet, conn, WoodenNickelIDL, WOODEN_NICKEL_PROGRAM_ID);
